    ...
    <section aria-labelledby="hero-title" className="relative flex min-h-[100svh] items-center bg-plum-deep px-4 py-4 text-primary-foreground sm:px-6 md:min-h-0 md:py-8 lg:min-h-[100svh]">
      <div className="mx-auto grid w-full max-w-6xl items-center gap-4 text-center md:grid-cols-[minmax(0,1fr)_minmax(260px,350px)] md:gap-10 md:text-left lg:grid-cols-[minmax(0,1fr)_minmax(300px,380px)] lg:gap-16">
        <div className="min-w-0">
          ...
          <h1 id="hero-title" className="mx-auto max-w-3xl font-display text-[1.7rem] font-semibold leading-[1.14] text-black sm:text-4xl md:mx-0 md:text-[2.6rem] lg:text-5xl">A forma como você se prepara durante a gestação pode <strong className="text-black">mudar completamente a sua experiência de parto.</strong></h1>
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-black sm:text-base md:mx-0 md:mt-5 lg:text-xl">Prepare seu acompanhante, evite a violência obstétrica e <strong className="text-black">viva o parto dos seus sonhos.</strong></p>
        </div>
